...
Nothing is uploaded or stored: a content script updates the page locally. Hover a stat after it is hidden to see a short note. 

Turn the extension off in `chrome://extensions` whenever you want real numbers again.
